...
Patcher.prototype.undoWithOps = function (state) {
  ...
  return [combine(this.type.apply(state, operations), state.history, transaction - 1, nextVersion(state, operations)), operations];
};
...
Patcher.prototype.redoWithOps = function (state) {
  ...
  return [combine(this.type.apply(state, operations), state.history, transaction, nextVersion(state, operations)), operations];
};
...
Patcher.prototype.insertOp = function (state, history, transaction, op) {
  ...
  var opsInverted = op.map(function (o) {
    return _objectSpread(_objectSpread({}, _this.type.invertWithDoc(o, state)), {}, {
      transaction: transaction
    });
  });
  return {
